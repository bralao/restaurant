...
const simpleNextArrow = (props) => {
  const { className, style, onClick } = props; // here we are destructuring the props, so we can use them directly in the return
  return (
    <div
      className={className} // here we are using the className directly,
  ...
  return (
    <div className="section-container my-20 relative">
      ...
      <div className="md:absolute right-3 top-8 mb-10 md:mr-24">
        {/*here we are using the ref to call the slickNext and slickPrev methods */}
